...
Ext.onReady(function() {
                ...
                var store_inventory_related_data = Ext.create('Ext.data.Store', {
					...
					proxy: {
						type: 'ajax',
						url : '/inventory/kehu/related_data.json',
						reader: {
							type: 'json',
							totalProperty  : 'total',
...
//
                ...
                var store_chart = Ext.create('Ext.data.JsonStore', {
					...
					proxy: {
						type: 'ajax',
						url : '/inventory/kehu/chart_data.json',
						reader: {
							type: 'json',
							totalProperty  : 'total',
							successProperty: 'success'
                ...
                var store_related_data_specific = Ext.create('Ext.data.Store', {
					...
					proxy: {
						type: 'ajax',
						url : '/inventory/kehu/related_data_specific.json',
						reader: {
							type: 'json',
							totalProperty  : 'total',
							successProperty: 'success'
...
function showRelatedDataSpecific(store_related_data_specific) {
    related_data_specific_grid = Ext.create('Ext.grid.Panel', {
					...
					columns: [
						...
						{text: "库存款金额", width: 80, dataIndex: 'inventory_money', sortable: true},
						{text: "用户", width: 235,  dataIndex: 'user', sortable: true},
						{text: "开票时间", width: 93, dataIndex: 'sign_time', sortable: true},
